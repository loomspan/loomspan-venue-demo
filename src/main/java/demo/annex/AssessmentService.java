...
public class AssessmentService {
    ...
    public AssessmentService(SkillTemplate skills,EventStore store,ObjectMapper mapper) {this.skills=skills;this.store=store;this.mapper=mapper;}
    public AssessmentView assess(String eventId) {
        ...
        try {
            ...
            String json=skills.invoke("assessEvent",Map.of("eventId",eventId),view->{
            ...
            return store.fail(pending.id(),"Assessment could not produce a validated option. Check model configuration or Console diagnostics, then retry. No resources were reserved.");
        }
    }
}
